...
def extract_labels2(f, one_hot=False, num_classes=10):
  """Extract the labels into a 1D uint8 numpy array [index].
...
class DataSet(object):
  ...
  def next_batch2(self, batch_size, fake_data=False):
...
def read_data_sets2(train_dir, fake_data=False, one_hot=False, dtype=tf.float32):
